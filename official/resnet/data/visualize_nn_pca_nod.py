...
PERCENT = 3
save_dir = '/media/katefgroup/rui/SegDepth/results/city_savedfeature_val'
save_dir = './30_nn_sim_val_nod'
save_dir = '/home/syalaman/tmp4/nn'
...
def saveOrLoadPCA(src_dir):
    global target_dim, source_dim
    picklepath = os.path.join(src_dir, 'pca_128.pkl')
...
def loadDataBuildTree():
    ...
    src_dir = '/media/katefgroup/rui/SegDepth/results/synthia_feature2048_nod/'
    src_dir = '/home/syalaman/tmp4/train/'

    tar_dir = '/media/katefgroup/rui/SegDepth/results/city_savedfeature_nod/'
    tar_dir = '/media/katefgroup/rui/SegDepth/results/city_savedfeature_val_nod/'
    tar_dir = '/home/syalaman/tmp4/val/'
...
def findNearestNeighborFromSource(id, x, y, return_dd=False):
    dd, ii = source_tree.query(target_feature[id, y, x, :], k=30)
...
if TESTING:
    for save_id in range(10):
        ...
        src_ids, src_xs, src_ys = findNearestNeighborFromSource(tar_id, tar_x, tar_y)
