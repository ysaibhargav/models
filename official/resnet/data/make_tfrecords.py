...
def _convert_to_example(filename, image_buffer, ingrs, height, width):
...
def _process_dataset(filenames, pickles, output_directory, prefix,
                     num_shards):
  """Processes and saves list of images as TFRecords.
  ...
  for shard in range(num_shards):
    ...
    chunk_pickles = pickles[shard * chunksize : (shard + 1) * chunksize]
...
def convert_to_tf_records(raw_data_dir):
  ...
  validation_records = _process_dataset(
      validation_files, validation_pickles,
